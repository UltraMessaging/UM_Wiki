...
&middot;&nbsp;&bull; [If you need a functional NAT, do not use these examples!](#if-you-need-a-functional-nat-do-not-use-these-examples)  
&bull; [Topology](#topology)  
&bull; [Example One-to-many NAT](#example-one-to-many-nat)  
&middot;&nbsp;&bull; [Save Normal State](#save-normal-state)  
&middot;&nbsp;&bull; [Restore Normal State](#restore-normal-state)  
&middot;&nbsp;&bull; [Start the NAT Running](#start-the-nat-running)  
&middot;&nbsp;&bull; [Set Skull Route](#set-skull-route)  
&middot;&nbsp;&bull; [Ping Test](#ping-test)  
&middot;&nbsp;&bull; [TCP Test](#tcp-test)  
&middot;&nbsp;&bull; [UDP Test](#udp-test)  
&middot;&nbsp;&bull; [UM Test](#um-test)  
&middot;&nbsp;&middot;&nbsp;&bull; [Configure Lbmrd](#configure-lbmrd)  
&middot;&nbsp;&middot;&nbsp;&bull; [Configure UM](#configure-um)  
